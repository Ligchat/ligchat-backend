        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    id_fluxo = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    mensagem_agendada_id = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_attachments_mensagens_agendadas_mensagem_agendada_id",
                        column: x => x.mensagem_agendada_id,
                        principalTable: "mensagens_agendadas",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    data_atualizacao = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    status = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    MessageSchedulingId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_etiquetas", x => x.id);
                    table.ForeignKey(
                        name: "FK_etiquetas_mensagens_agendadas_MessageSchedulingId",
                        column: x => x.MessageSchedulingId,
                        principalTable: "mensagens_agendadas",
                        principalColumn: "id");
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_attachments_mensagem_agendada_id",
                table: "attachments",
                column: "mensagem_agendada_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_etiquetas_MessageSchedulingId",
                table: "etiquetas",
                column: "MessageSchedulingId");
